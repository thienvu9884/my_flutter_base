...
mixin _$LanguageModel {
 ...
 String? get id; String? get english; String? get vietnamese;@TimestampConverter() DateTime? get createdAt;@TimestampConverter() DateTime? get updatedAt;
...
@override
String toString() {
  return 'LanguageModel(id: $id, english: $english, vietnamese: $vietnamese, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String? id, String? english, String? vietnamese,@TimestampConverter() DateTime? createdAt,@TimestampConverter() DateTime? updatedAt
});
...
/// Create a copy of LanguageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? english = freezed,Object? vietnamese = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String?,english: freezed == english ? _self.english : english // ignore: cast_nullable_to_non_nullable
as String?,vietnamese: freezed == vietnamese ? _self.vietnamese : vietnamese // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? english,  String? vietnamese, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? english,  String? vietnamese, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _LanguageModel():
return $default(_that.id,_that.english,_that.vietnamese,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? english,  String? vietnamese, @TimestampConverter()  DateTime? createdAt, @TimestampConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _LanguageModel() when $default != null:
return $default(_that.id,_that.english,_that.vietnamese,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _LanguageModel extends LanguageModel {
  const _LanguageModel({this.id, this.english, this.vietnamese, @TimestampConverter() this.createdAt, @TimestampConverter() this.updatedAt}): super._();
...
/// Create a copy of LanguageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? english = freezed,Object? vietnamese = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
