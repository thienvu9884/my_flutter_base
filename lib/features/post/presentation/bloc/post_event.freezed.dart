...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _GetPostsEvent value)?  getPosts,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetPostsEvent() when getPosts != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _GetPostsEvent value)  getPosts,}){
final _that = this;
switch (_that) {
case _GetPostsEvent():
return getPosts(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _GetPostsEvent value)?  getPosts,}){
final _that = this;
switch (_that) {
case _GetPostsEvent() when getPosts != null:
return getPosts(_that);case _:
...
class _GetPostsEvent extends PostEvent {
  const _GetPostsEvent(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetPostsEvent);
}
